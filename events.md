...
| 7b | Server spawns 2 capture points (Horses, Spears) | `TEST_CAPTURE_SPAWN` | server.log + client_A.log + client_B.log | 0s |
...
| 10a2 | Captured points produce resources every 2s | `TEST_RESOURCE` | server.log | continues |
